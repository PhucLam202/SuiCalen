    ...
    <section className="relative min-h-screen w-full overflow-hidden bg-neo-bg flex flex-col items-center pt-20 pb-10">
      ...
      <div className="container mx-auto px-4 z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-8 text-center lg:text-left relative z-20">
          <ScrollReveal>
            <div className="inline-flex items-center gap-2 bg-neo-warning border-4 border-black px-6 py-3 mb-6 shadow-neo rotate-[-1deg] hover:rotate-0 transition-transform cursor-pointer group">
              <span className="w-3 h-3 bg-red-600 rounded-full animate-pulse group-hover:scale-125 transition-transform"></span>
              <span className="font-display font-black text-sm uppercase tracking-wider">SUI MAINNET LIVE</span>
            </div>
          </ScrollReveal>

          <ScrollReveal delay={200}>
            <h1 className="font-display text-6xl md:text-8xl lg:text-9xl font-black leading-[0.85] tracking-tighter text-black uppercase">
              Schedule <br />
              Payments <br />
              <span className="relative inline-block">
                <span className="relative z-10 bg-neo-primary text-white px-6 italic transform -skew-x-6 inline-block shadow-neo">LIKE MEETINGS</span>
                <div className="absolute -inset-2 bg-black -z-0 transform -skew-x-6 translate-x-2 translate-y-2"></div>
              </span>
            </h1>
          </ScrollReveal>

          <ScrollReveal delay={400}>
            <p className="font-body text-xl md:text-2xl font-bold text-gray-900 max-w-xl mx-auto lg:mx-0 border-l-[6px] border-neo-secondary pl-8 py-4 bg-white/50 backdrop-blur-sm shadow-neo-sm">
              Turn Google Calendar into a non-custodial interface for <span className="text-neo-primary underline decoration-4 underline-offset-4">Sui</span>.
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <div className="font-display text-2xl font-black border-b-4 border-neo-primary pb-2 flex items-center justify-between">
                  <span>Pay 500 $SUI</span>
                  <span className="text-sm bg-neo-primary text-white px-3 py-1 font-display font-bold">DRAFT</span>
                </div>
              </div>
              ...
              <div className="bg-gray-50 border-2 border-black p-3 mb-6" data-cy='transaction-details'>
                <div className="flex justify-between items-center mb-2 border-b border-gray-300 pb-2">
                  ...
                  <span className="font-mono text-xs font-bold text-black">0.01 SUI</span>
                </div>
